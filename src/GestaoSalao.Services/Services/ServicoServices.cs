...
{
    public class ServicoServices : BaseServices<Servico>, IServicoServices
    {
        #region Propriedades e Construtor


        public ServicoServices(IUnitOfWork unitOfWork) : base(unitOfWork)
        {
        }
        ...
        public string Inserir(Servico dados)
        {
        ...
        private string Validar(Servico dados, bool insert = true)
        {
            ...
            return dadosDataIgual != null 
                ? "Existe um serviço com o mesmo nome cadastrado" : string.Empty;
        }
